<script>
	...
	$: passwordStyle = passwordValidationResult[0]
		? 'input input-success variant-form-material'
	...
	$: emailStyle = emailValidationResult
		? 'input input-success variant-form-material'
		: 'input input-error variant-form-material';

	$: usernameValidationResult = isValidUsername(username);
	$: usernameStyle = usernameValidationResult
		? 'input input-success variant-form-material'
		: 'input input-error variant-form-material';
	...
	<div class="max-w-md mx-auto">
		...
		<form>
			...
			<div class="mb-4">
				...
				<input type="password" id="password" bind:value={password} class={passwordStyle} required />
			</div>
